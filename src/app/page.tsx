        ...
        <section className="pt-20 pb-32 px-4 md:px-6 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="gradient-text">Stallion</span>
            </h1>
        ...
        <section className="py-20 px-4 md:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold">Featured Bounties</h2>
              <Link href="/bounties" className="text-stellar-blue hover:underline font-medium">
                View All →
              </Link>
            </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="card hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="font-semibold text-green-600">$250-500</span>
                  </div>
                  <h3 className="text-xl font-semibold mb-2">Build a Stellar Wallet Integration</h3>
                  <p className="text-gray-600 mb-6 line-clamp-3">
                    Create a seamless wallet integration for our platform using Soroban smart contracts...
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Posted 2 days ago</span>
                    <Link href={`/bounties/${i}`} className="text-stellar-blue hover:underline font-medium">
                      View Details →
                    </Link>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-8 md:mb-0">
                ...
                <p className="text-gray-400">Built on the Stellar blockchain</p>
              </div>
            ...
            <div className="mt-8 flex justify-center md:justify-start space-x-6">
              <a href="https://x.com/Stallionsassmbl" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://discord.gg/8rKFQHNtb3" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://stallionss.gitbook.io/stallions" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
